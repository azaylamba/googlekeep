...
You have to design & build the backend for the application and the ability for the users to register, take notes, find notes and share notes to other users.
...
https://github.com/azaylamba/googlekeep
